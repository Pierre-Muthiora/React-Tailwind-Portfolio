...
const Home = () => {
  return (
    ...
    exit={{opacity: 1}} 
    id="home" className=" flex min-h-screen opacity-100 px-3">
        <div id="container" className="m-auto w-full">
          <div id="row" className="relative flex flex-col-reverse lg:flex-row">
            {/*========= home-info container ==========*/}
            <div
              id="home info"
              className="px-4 max-w-full lg:max-w-[60%] mb-16"
            >
              <h3 id="hello" className="text-3xl my-4 font-bold font-serif dark:text-slate-200">
                Hi, my name is{" "}
                <span
                  id="name"
            ...
            >
              ...
              <img className="h-[400px] m-auto pb-6 rounded-full" src="pics\me1.png" alt="me" />
            </div>
          </div>
        </div>
      </m.div>
